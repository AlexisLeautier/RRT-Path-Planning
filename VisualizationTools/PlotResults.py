...
def main():
    ...
    ObsPath = current_dir + '/../Results/Obstacles.csv'
    Obstacles = {}
    ...
    fieldnames = ['x', 'y']
    TreePath = current_dir + '/../Results/Tree.csv'
    TreeXY= {}
    ...
    with open(TreePath, 'r+') as csvfile:
        ...
        for row in itertools.islice(csvfile, 1, None):
                ...
                for i, value in enumerate(values):
                    ...
                    point[fieldnames[i]] = nValue
                    # Plot Tree points
                ax.plot(point['x'], point['y'], 'o', markeredgecolor="None", color='#43d5ef', ms = 2.7)
                plt.draw()
                plt.pause(0.001)
    ...
    TrajPath = current_dir + '/../Results/Trajectory.csv'
    TrajXY = {}
