...
"""
    ...
    Description: PlotResults.py uses the csv files generated by the cpp path planning scripts in
        order to plot a visualization of the results of the search. As this file is an executab-
        le, it can be launched directly from a command line without arguments from RRT-Path-Pla-
        nning as "VisualizationTools/PlotResults.py". 
"""
